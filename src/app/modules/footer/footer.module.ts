...
import { ConichiFooterComponent } from './footer.component';


/*
* @NgModule: ConichiFooterModule
*
...
@NgModule({
  ...
  exports: [ ConichiFooterComponent ],
  declarations: [ ConichiFooterComponent ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA ]
})
export class ConichiFooterModule { }
